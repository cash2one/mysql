...
Source Database       : accountsku

Target Server Type    : MYSQL
Target Server Version : 50524
File Encoding         : 65001

Date: 2016-10-31 10:54:53
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=1646 DEFAULT CHARSET=utf8 COMMENT='接口访问日志';
...
CREATE TABLE `gw_sku_account_flow_201601` (
  ...
  KEY `node` (`node`) USING BTREE,
  KEY `export_batch` (`export_batch`)
) ENGINE=InnoDB AUTO_INCREMENT=1119 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `gw_sku_account_flow_201602` (
  ...
  KEY `node` (`node`) USING BTREE,
  KEY `export_batch` (`export_batch`)
) ENGINE=InnoDB AUTO_INCREMENT=1192 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `gw_sku_account_flow_201603` (
  ...
  KEY `node` (`node`) USING BTREE,
  KEY `export_batch` (`export_batch`)
) ENGINE=InnoDB AUTO_INCREMENT=1276 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `gw_sku_account_flow_201604` (
  ...
  KEY `node` (`node`) USING BTREE,
  KEY `export_batch` (`export_batch`)
) ENGINE=InnoDB AUTO_INCREMENT=1200 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;
...
CREATE TABLE `gw_sku_account_flow_201609` (
  ...
  KEY `node` (`node`) USING BTREE,
  KEY `export_batch` (`export_batch`)
) ENGINE=InnoDB AUTO_INCREMENT=42842 DEFAULT CHARSET=utf8 ROW_FORMAT=COMPACT;

-- ----------------------------
-- Table structure for gw_sku_account_flow_201610
-- ----------------------------
DROP TABLE IF EXISTS `gw_sku_account_flow_201610`;
CREATE TABLE `gw_sku_account_flow_201610` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '主键',
  `account_id` int(11) unsigned NOT NULL COMMENT '所属账号',
  `sku_number` varchar(32) NOT NULL COMMENT 'sku号',
  `date` date NOT NULL COMMENT '日期',
